...
class Ui_optimizer_ui(object):
    ...
    def retranslateUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.setItemText(26, QCoreApplication.translate("optimizer_ui", u"Ranger21", None))
        self.optimizer_type_selector.setItemText(27, QCoreApplication.translate("optimizer_ui", u"CompassPlus", None))
        self.optimizer_type_selector.setItemText(28, QCoreApplication.translate("optimizer_ui", u"FCompassPlus", None))
        ...
        self.optimizer_type_selector.setItemText(46, QCoreApplication.translate("optimizer_ui", u"FADOPTMARSScheduleFree", None))
