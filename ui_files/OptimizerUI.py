...
class Ui_optimizer_ui(object):
    ...
    def retranslateUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.setItemText(18, QCoreApplication.translate("optimizer_ui", u"AdEMAMix", None))
        self.optimizer_type_selector.setItemText(19, QCoreApplication.translate("optimizer_ui", u"FCompass", None))
        self.optimizer_type_selector.setItemText(20, QCoreApplication.translate("optimizer_ui", u"FishMonger", None))
        self.optimizer_type_selector.setItemText(21, QCoreApplication.translate("optimizer_ui", u"FishMonger8BitBNB", None))
        self.optimizer_type_selector.setItemText(22, QCoreApplication.translate("optimizer_ui", u"FARMSCrop", None))
        self.optimizer_type_selector.setItemText(23, QCoreApplication.translate("optimizer_ui", u"Compass8BitBNB", None))
        self.optimizer_type_selector.setItemText(24, QCoreApplication.translate("optimizer_ui", u"Ranger21", None))
        self.optimizer_type_selector.setItemText(25, QCoreApplication.translate("optimizer_ui", u"CompassPlus", None))
        self.optimizer_type_selector.setItemText(26, QCoreApplication.translate("optimizer_ui", u"FCompassPlus", None))
        self.optimizer_type_selector.setItemText(27, QCoreApplication.translate("optimizer_ui", u"Adan", None))
        self.optimizer_type_selector.setItemText(28, QCoreApplication.translate("optimizer_ui", u"ADOPT", None))
        self.optimizer_type_selector.setItemText(29, QCoreApplication.translate("optimizer_ui", u"GrokFastAdamW", None))
        self.optimizer_type_selector.setItemText(30, QCoreApplication.translate("optimizer_ui", u"AdamMini", None))
        self.optimizer_type_selector.setItemText(31, QCoreApplication.translate("optimizer_ui", u"AdaBelief", None))
        self.optimizer_type_selector.setItemText(32, QCoreApplication.translate("optimizer_ui", u"GaLore", None))
        self.optimizer_type_selector.setItemText(33, QCoreApplication.translate("optimizer_ui", u"ScheduleFreeWrapper", None))
        self.optimizer_type_selector.setItemText(34, QCoreApplication.translate("optimizer_ui", u"FARMSCropV2", None))
        self.optimizer_type_selector.setItemText(35, QCoreApplication.translate("optimizer_ui", u"FMARSCrop", None))
        self.optimizer_type_selector.setItemText(36, QCoreApplication.translate("optimizer_ui", u"ADOPTScheduleFree", None))
        self.optimizer_type_selector.setItemText(37, QCoreApplication.translate("optimizer_ui", u"ADOPTEMAMixScheduleFree", None))
        self.optimizer_type_selector.setItemText(38, QCoreApplication.translate("optimizer_ui", u"ADOPTNesterovScheduleFree", None))
        self.optimizer_type_selector.setItemText(39, QCoreApplication.translate("optimizer_ui", u"FADOPTScheduleFree", None))
        self.optimizer_type_selector.setItemText(40, QCoreApplication.translate("optimizer_ui", u"ADOPTMARSScheduleFree", None))
        self.optimizer_type_selector.setItemText(41, QCoreApplication.translate("optimizer_ui", u"FADOPTMARSScheduleFree", None))
        self.optimizer_type_selector.setItemText(42, QCoreApplication.translate("optimizer_ui", u"CompassADOPT", None))
        self.optimizer_type_selector.setItemText(43, QCoreApplication.translate("optimizer_ui", u"RMSPropADOPT", None))
        self.optimizer_type_selector.setItemText(44, QCoreApplication.translate("optimizer_ui", u"CompassADOPTMARS", None))
        ...
        self.optimizer_type_selector.setItemText(50, QCoreApplication.translate("optimizer_ui", u"FMARSCropV2ExMachina", None))
