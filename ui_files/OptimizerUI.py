...
class Ui_optimizer_ui(object):
    ...
    def retranslateUi(self, optimizer_ui):
        ...
        self.optimizer_type_selector.setItemText(28, QCoreApplication.translate("optimizer_ui", u"CompassExperimental", None))
        self.optimizer_type_selector.setItemText(29, QCoreApplication.translate("optimizer_ui", u"FCompassPlus", None))
