...
#if QT_CONFIG(tooltip)
        self.train_blocks_label.setToolTip(QCoreApplication.translate("network_ui", u"<html><head/><body><p>Select blocks to train,aingle blocks, double blocks, or all (both).</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
